//Solution of dynamic range minimum query problem 
//Using segment tree query & update methods

//There are two types of queries, 
//Type 1: Find the minimum element in the given range
//Type 2: Given index of the array, update the element
